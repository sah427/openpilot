...
_AWARENESS_TIME = 4600.  # two hour limit without user touching steering wheels make the car enter a terminal status
_AWARENESS_PRE_TIME_TILL_TERMINAL = 1000.  # a first alert is issued 25s before expiration
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 900.  # a second alert is issued 15s before start decelerating the car
_DISTRACTED_TIME = 4000.
